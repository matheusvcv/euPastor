...
include"../../src/conexao.php";//Inclui o arquivo que faz conexão com o banco de dados.
	...
	if(isset($_POST['email'])){//Verifica se o e-mail foi enviado via POST.
        ...
        $email = filter_var(filter_input(INPUT_POST, 'email', FILTER_SANITIZE_EMAIL), FILTER_VALIDATE_EMAIL);//Define a variável $email com o valor enviado via Post no campo email. A função filter_input reduz o risco de injeção de código malicioso. A função filter_validade_email verifica se o email tem um formato válido.
