  ...
  <div class="card card_body m-3">
    <div class="card-content collapse show">
      <div class="card-body card-dashboard">
          ...
          <h1 class="mb-4">Manual do MyChurch WebSystem</h1>
    ...
    <h2 class="mb-3">Módulos Disponíveis</h2>
    <div class="accordion" id="modulosAccordion">

      <!-- Módulo 1 -->
      <div class="accordion-item">
        <h2 class="accordion-header" id="heading1">
          <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#modulo1" aria-expanded="true" aria-controls="modulo1">
            1. Escola Bíblica Dominical
          </button>
        </h2>
        <div id="modulo1" class="accordion-collapse collapse show" aria-labelledby="heading1" data-bs-parent="#modulosAccordion">
